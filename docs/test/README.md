...
| [Pack B — 可观测中心](./pack_b_observability_test.md) | Pack B (S5+S6) | 13 | Dashboard 统计、Prometheus、Grafana、Alertmanager |
...
| [Pack F — 第三方登录](./pack_f_third_party_auth_test.md) | Pack F | 17 | LDAP、钉钉/飞书/企微 OAuth2、OIDC、CSRF 防护 |
