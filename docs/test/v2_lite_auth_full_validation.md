...
### TC-AUTH-004 核心后台列表页表格体验统一

步骤：

1. 依次打开用户管理、用户组管理、资源组管理、角色管理、审批流管理、实例管理、工单模板、审计日志。
2. 观察列宽、长文本显示、标签密度和滚动行为。
...
### TC-AUTH-025A SQL 工单提交页不再手动选资源组
...
2. 进入“SQL 工单 -> 提交工单”。
3. 查看实例/数据库区域。
4. 选择自己有权限的实例和数据库后提交工单。

预期：

- 页面上不存在手动选择资源组的表单项
- 页面有提示说明资源组由系统自动解析
- 工单可正常提交，且目标实例必须在当前用户资源范围内
